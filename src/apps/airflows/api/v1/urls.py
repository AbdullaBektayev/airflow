...
from apps.airflows.api.v1.views.airflow_search_views import AirflowSearchCreateAPIView
from apps.airflows.api.v1.views.provider_views import ProviderAListAPIView, ProviderBListAPIView
